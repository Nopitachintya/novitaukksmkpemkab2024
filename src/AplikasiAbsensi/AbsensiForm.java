...
public class AbsensiForm extends javax.swing.JInternalFrame {
    ...
    public void TampilkanData(){
        ...
        try{
            ...
            while(res.next()){
                    model.addRow(new Object[] {id++,res.getString(1),res.getString(2),res.getString(3),res.getString(4)
                    });
        } 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      try{
            Koneksi();
            String sql = "insert into absensi values('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+lahir.getText()+"','"+alamat.getText()+"')";
    ...
    int baris = jTable1.rowAtPoint(evt.getPoint());
        ...
        String ttl = jTable1.getValueAt(baris, 3).toString();
        lahir.setText(ttl);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            String sql = "UPDATE absensi SET id = '"+jTextField1.getText()+"',"+ "nama='"+jTextField2.getText()+"',Tempat Tanggal Lahir='"+lahir.getText()+"',Alamat='"+alamat.getText()+"' WHERE id = '"+jTextField1.getText()+"'";
            java.sql.Connection conn = (Connection)koneksi.getConnection();
